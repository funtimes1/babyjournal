...
const AppTheme = {
  ...
  colors: {
    ...
    // calendar
    calendarSelectedDay: GlobalColors.trueGray['900'],
    calendarDayBackgroundInactive: GlobalColors.trueGray['100'],
    calendarDayBorder: GlobalColors.trueGray['400'],
    calendarDayText: GlobalColors.trueGray['800'],
    calendarDayTextInactive: GlobalColors.trueGray['300'],
  },
  sizes: {
    '4xs-4': 4,
    '3xs-8': 8,
